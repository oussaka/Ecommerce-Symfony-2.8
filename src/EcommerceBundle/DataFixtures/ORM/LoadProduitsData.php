...
class LoadProduitsData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $produit2->setCategories($this->getReference('categorie1'));
        ...
        $produit3->setCategories($this->getReference('categorie1'));
        ...
        $produit4->setCategories($this->getReference('categorie1'));
        ...
        $produit5->setCategories($this->getReference('categorie2'));
        ...
        $produit6->setCategories($this->getReference('categorie2'));
